...
The source code is on [GitHub](https://github.com/Akshat0210/playground-np8k7fqr), please feel free to come up with proposals to improve it.

# Hands-on Demo

@[Luke, how many stars are there in these galaxies?]({"stubs": ["src/main/java/com/yourself/Universe.java"], "command": "javac com.yourself.Universe.java && mvn test -Dtest=com.yourself.UniverseTest"})
