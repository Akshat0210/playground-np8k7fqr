...
@[Luke, how many stars are there in these galaxies?]({"stubs": ["src/main/java/com/yourself/Universe.java"], "command": "mvn build && mvn test -Dtest=com.yourself.UniverseTest"})
