...
@[Luke, how many stars are there in these galaxies?]({"stubs": ["src/test/java/com/yourself/UniverseTest.java"], "command": "mvn build && mvn test -Dtest=com.yourself.UniverseTest"})
